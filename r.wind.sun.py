...
#		grass.run_command('nviz',elevation='fdem',vector=windfarm3);
		...
		for i in b:
			...
			grass.run_command('r.los',input=dem,output='step_up',coordinate=coordinate,obs_elev=m_u,max_dist=f);
			grass.run_command('r.los',input=dem,output='step_low',coordinate=coordinate,obs_elev=m_l,max_dist=f);
			grass.run_command('r.los',input=dem,output='step_half',coordinate=coordinate,obs_elev=m_h,max_dist=f);
		...
		for i in e:
			...
			grass.run_command('r.los',input=dem,output='los_degree_'+str(cat),coordinate=coordinate,obs_elev=obs_elev,max_dist=max_dist_from_panel);
