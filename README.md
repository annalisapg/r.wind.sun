...
# r.photovoltaic
r.photovoltaic updates r.wind.sun code to be used in GRASS GIS 8 for the part limited to photovoltaic panels. The code is in very-alpha version, but all the functionalities of r.wind.sun have been updated and this specific part (photovoltaic panels visibility impact) has been recently used to evaluate visibility of existing and potential aquaculture facilites within Gaeta Gulf (Italy). 
